const data = {
  ...
  certificate: [
    {
      date: 'Jan 2021',
      description:
        'Hack up furballs try to jump onto window and fall while scratching at wall. ',
      institution: 'Platzi',
    ...
    },
    {
      date: 'Jan 2021',
      description:
        'Scratch at the door then walk away wack the mini furry mouse',
      institution: 'Platzi',
  ...
  education: [
    ...
    },
    {
      ...
      endDate: '2017',
      institution: 'Instituto Tecnológico Mario Molina ',
      startDate: '2013',
    },
  ],
  experience: [
  ...
  social: [
    ...
    {
      name: 'linkedin',
      url: 'https://www.linkedin.com/in/ramiro-alva-525883123',
    },
  ],
};
